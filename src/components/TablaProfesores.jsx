...
const TablaProfesores = ({ data, setEditar, mostrarModal, setMostrarModal, eliminarProfesor, setSoloVer }) => {

    const enviarDatos = (profesor, soloVer) => {
        setEditar(profesor);
        setSoloVer(soloVer);
                        ...
                        data.map((item) => (
                            <tr key={item.id} >
                                ...
                                <td>
                                    ...
                                    <Button color="danger" size="sm" onClick={() => eliminarProfesor(item.id)} >Eliminar</Button>
                                </td>
                            </tr>
                        ))
